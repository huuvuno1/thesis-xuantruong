    ...
    <div className="main-container">
      ...
      <div className="frame">
        ...
        <span className="outfit-description-c">
          ...
          ngoài quần tây ra thì quần jean được các bạn nam chọn dùng nhiều nhất
          bởi sự tiện lợi, năng động, hợp bất kỳ kiểu dáng nào.
        </span>
        ...
        <span className="outfit-description-e">
          Một kiểu phối đồ luôn được nhiều bạn trẻ yêu thích, áo sơ mi form rộng
          kết hợp với chiếc quần tây đen hoặc trắng tạo nên nét thư sinh, thanh
          lịch và khá hợp thời trang, kiểu phối này không cầu kỳ hay phức tạp
          nhưng luôn giữ được vẻ chất lừ.
        </span>
