          ...
          <div className={styles.contentWrapper}>
            ...
            <div>
              <div className={styles.quoteWrapper}>
                <p>
                  Nếu bạn thường xuyên khó khăn trong việc chọn lựa hay phối đồ,
                  không biết mặc gì khi đi làm, đi chơi, hay dự tiệc... Đến với
                  365 Simple, chúng tôi sẽ giúp bạn phần còn lại
                </p>
                <p>
          ...
          <div className={styles.hehe}>
            <div className={styles.ptWrapperContentWrapper}>
              ...
              <div className={styles.ptWrapperContent}>
                ...
                <p>
                  Sẵn sàng với mọi công việc, đáp ưng mọi yêu cầu của khách hàng
                </p>
              </div>
            </div>
            ...
            <div className={styles.ptWrapperContentWrapper}>
              ...
              <div className={styles.ptWrapperContent}>
                ...
                <p>
                  Trách nhiệm với khách hàng, trách nhiệm trong mọi lời nói của
                  chúng tôi
                </p>
              </div>
        ...
        <div className={styles.customerTalkAboutMe}>
          <div>
            ...
            <p className={styles.customerTalkAboutMeDesc}>
              ...
              ngày đều rất mất thời gian để chọn đồ, phối đồ. Khi biết tới 365
              Simple mình được tư vấn rất nhiệt tình, sản phẩm mua về cũng chất
              lượng. Nói chung là đáng để thử
            </p>
