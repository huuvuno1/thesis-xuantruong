...
import NewsDetailResponsive from '@/responsive/NewsDetailResponsive';
              ...
              <div className={styles.articleWrapperItem}>
                ...
                <div className={styles.detailItem}>
                  ...
                  <p className={styles.detailItemDesc}>
                    ...
                    rộng, thường ngoài quần tây ra thì quần jean được các bạn
                    nam chọn dùng nhiều nhất bởi sự tiện lợi, năng động, hợp bất
                    kỳ kiểu dáng nào.
                  </p>
                </div>
                ...
                <div className={styles.detailItem}>
                  ...
                  <p className={styles.detailItemDesc}>
                    ...
                    nét thư sinh, thanh lịch và khá hợp thời trang, kiểu phối
                    này không cầu kỳ hay phức tạp nhưng luôn giữ được vẻ chất
                    lừ.
                  </p>
                </div>
                ...
                <div className={styles.detailItem}>
                  ...
                  <p className={styles.detailItemDesc}>
                    ...
                    cách năng động, trẻ trung và linh hoạt, chiếc áo sơ form
                    giúp các chàng trai trông to con hơn nếu có vóc dáng gầy, tô
                    điểm cho ngoại hình.
                  </p>
                </div>
              </div>
